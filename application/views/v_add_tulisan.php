...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'tulisan/add_tulisan'?>"><i class="fa fa-thumb-tack"></i> Post Berita</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
		...
		<form action="<?php echo base_url().'tulisan/simpan_tulisan'?>" method="post" enctype="multipart/form-data">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright <?php echo date('Y');?> <a href="http://smkpenanusantara.sch.id">SMK PENA NUSANTARA</a>.</strong> All rights reserved.
  </footer>
