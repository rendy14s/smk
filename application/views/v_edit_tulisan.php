...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        $b=$data->row_array();
    ?>
		<form action="<?php echo base_url().'tulisan/update_tulisan'?>" method="post" enctype="multipart/form-data">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright <?php echo date('Y');?> <a href="http://mfikri.com">SMK PENA NUSANTARA</a>.</strong> All rights reserved.
  </footer>
